...
namespace Client.MirControls
{
    public sealed class MirItemCell : MirImageControl
    {
                ...
                case MouseButtons.Right:
                    ...
                    if (CMain.Shift)
                    {
                        if (Item != null)
                        {
                            ...
                            {
                                GameScene.Scene.ChatDialog.ReceiveChat("超出允许的最大字数限制，物品链接发送失败", ChatType.System);
                                return;
                            }
                    ...
                    if (CMain.Shift)
                    {
                        if (GridType == MirGridType.Inventory || GridType == MirGridType.Storage)
                        {
                            if (GameScene.SelectedCell == null && Item != null)
                            {
                                if (FreeSpace() == 0)
                                {
                                    GameScene.Scene.ChatDialog.ReceiveChat("没有足够的空间拆分堆叠物品.", ChatType.System);
                                    return;
                                }

                                if (Item.Count > 1)
                                {
                                    MirAmountBox amountBox = new MirAmountBox("拆分:", Item.Image, (uint)(Item.Count - 1));
                ...
                switch (GridType)
                {
                        ...
                        switch (GameScene.SelectedCell.GridType)
                        {
                            ...
                            case MirGridType.Inventory: //From Invenotry
                                if (Item != null)
                                {
                                    if (CMain.Ctrl)
                                    {
                                        MirMessageBox messageBox = new MirMessageBox("你想尝试組合这些物品吗?", MirMessageBoxButtons.YesNo);
                        ...
                        switch (GameScene.SelectedCell.GridType)
                        {
                            case MirGridType.GuildStorage: //From Guild Storage
                                if (GameScene.SelectedCell.GridType == MirGridType.GuildStorage)
                                {
                                    ...
                                    {
                                        GameScene.Scene.ChatDialog.ReceiveChat("你没有权限储存物品.", ChatType.System);
                                        return;
                                    }
                            ...
                            case MirGridType.Inventory:
                                ...
                                if (GameScene.SelectedCell.GridType == MirGridType.Inventory)
                                {
                                    if (Item != null)
                                    {
                                        GameScene.Scene.ChatDialog.ReceiveChat("你无法替换这个物品.", ChatType.System);
                                        return;
                                    }
                                    if (!GuildDialog.MyOptions.HasFlag(GuildRankOptions.CanStoreItem))
                                    {
                    ...
                    case MirGridType.Mail: //To Mail
                        if (GameScene.SelectedCell.GridType == MirGridType.Inventory)
                        {
                            ...
                            {
                                GameScene.Scene.ChatDialog.ReceiveChat("你无法邮寄这个物品.", ChatType.System);
                                return;
                            }
        ...
        private bool CanUseItem()
        {
            ...
            switch (actor.Gender)
            {
                case MirGender.男:
                    ...
                    {
                        GameScene.Scene.ChatDialog.ReceiveChat("限女性角色使用", ChatType.System);
                        return false;
                    }
                    break;
                case MirGender.女:
                    ...
                    {
                        GameScene.Scene.ChatDialog.ReceiveChat("限男性角色使用", ChatType.System);
                        return false;
                    }
                    break;
            }
            ...
            switch (actor.Class)
            {
                case MirClass.战士:
                    ...
                    {
                        GameScene.Scene.ChatDialog.ReceiveChat("战士无法使用此物品.", ChatType.System);
                        return false;
                    }
                    break;
                case MirClass.法师:
                    ...
                    {
                        GameScene.Scene.ChatDialog.ReceiveChat("法师无法使用此物品.", ChatType.System);
                        return false;
                    }
                    break;
                case MirClass.道士:
                    ...
                    {
                        GameScene.Scene.ChatDialog.ReceiveChat("道士无法使用此物品.", ChatType.System);
                        return false;
                    }
                    break;
                case MirClass.刺客:
                    ...
                    {
                        GameScene.Scene.ChatDialog.ReceiveChat("刺客无法使用此物品.", ChatType.System);
                        return false;
                    }
                    break;
                case MirClass.弓箭手:
                    if (!Item.Info.RequiredClass.HasFlag(RequiredClass.弓箭手))
                    {
                        GameScene.Scene.ChatDialog.ReceiveChat("弓箭手无法使用此物品.", ChatType.System);
                        return false;
                    }
                    break;
            }
            ...
            switch (Item.Info.RequiredType)
            {
                case RequiredType.Level:
                    ...
                    {
                        GameScene.Scene.ChatDialog.ReceiveChat("你的等级太低", ChatType.System);
                        return false;
                    }
                    break;
                ...
                case RequiredType.MaxDC:
                    ...
                    {
                        GameScene.Scene.ChatDialog.ReceiveChat("攻击不足", ChatType.System);
                        return false;
                    }
                    break;
                case RequiredType.MaxMC:
                    ...
                    {
                        GameScene.Scene.ChatDialog.ReceiveChat("魔法不足", ChatType.System);
                        return false;
                    }
                    break;
                case RequiredType.MaxSC:
                    ...
                    {
                        GameScene.Scene.ChatDialog.ReceiveChat("道术不足", ChatType.System);
                        return false;
                    }
                    break;
                case RequiredType.MaxLevel:
                    if (actor.Level > Item.Info.RequiredAmount)
                    {
                        GameScene.Scene.ChatDialog.ReceiveChat("你已经超过了最高使用等级.", ChatType.System);
                        return false;
                    }
                    break;
                ...
                case RequiredType.MinDC:
                    ...
                    {
                        GameScene.Scene.ChatDialog.ReceiveChat("基础攻击不足.", ChatType.System);
                        return false;
                    }
                    break;
                case RequiredType.MinMC:
                    ...
                    {
                        GameScene.Scene.ChatDialog.ReceiveChat("基础魔法不足.", ChatType.System);
                        return false;
                    }
                    break;
                case RequiredType.MinSC:
                    ...
                    {
                        GameScene.Scene.ChatDialog.ReceiveChat("基础道术不足.", ChatType.System);
                        return false;
                    }
                    break;
            }
            ...
            switch (Item.Info.Type)
            {
                ...
                case ItemType.Reins:
                    ...
                    {
                        GameScene.Scene.ChatDialog.ReceiveChat("你没有装备坐骑.", ChatType.System);
                        return false;
                    }
                    break;
                case ItemType.Hook:
                ...
                case ItemType.Reel:
                    ...
                    {
                        GameScene.Scene.ChatDialog.ReceiveChat("你没有装备渔具.", ChatType.System);
                        return false;
                    }
                    break;
            }
        ...
        private bool CanWearItem(UserObject actor, UserItem i)
        {
            ...
            {
                case MirGender.男:
                    if (!i.Info.RequiredGender.HasFlag(RequiredGender.男))
                    {
                        GameScene.Scene.ChatDialog.ReceiveChat("限女性角色使用", ChatType.System);
                        return false;
                    }
                    break;
                case MirGender.女:
                    if (!i.Info.RequiredGender.HasFlag(RequiredGender.女))
                    {
                        GameScene.Scene.ChatDialog.ReceiveChat("限男性角色使用", ChatType.System);
                        return false;
                    }
            ...
            switch (actor.Class)
            {
                ...
                case MirClass.刺客:
                    ...
                    break;
                case MirClass.弓箭手:
                    if (!i.Info.RequiredClass.HasFlag(RequiredClass.弓箭手))
                    {
                        GameScene.Scene.ChatDialog.ReceiveChat("弓箭手无法使用此物品.", ChatType.System);
                        return false;
                    }
            ...
            switch (i.Info.RequiredType)
            {
                ...
                case RequiredType.MinMC:
                    ...
                    {
                        GameScene.Scene.ChatDialog.ReceiveChat("基础魔魔法不足.", ChatType.System);
                        return false;
                    }
                    break;
                case RequiredType.MinSC:
            ...
            if (i.Info.Type == ItemType.Weapon || i.Info.Type == ItemType.Torch)
            {
                ...
                {
                    GameScene.Scene.ChatDialog.ReceiveChat("腕力不足", ChatType.System);
                    return false;
                }
            }
            else
            {
                ...
                {
                    GameScene.Scene.ChatDialog.ReceiveChat("负重不足，无法穿戴", ChatType.System);
                    return false;
                }
            }

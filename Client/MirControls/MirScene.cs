...
namespace Client.MirControls
{
    public abstract class MirScene : MirControl
    {
        ...
        private static void Disconnect(S.Disconnect p)
        {
            ...
            {
                case 0:
                    MirMessageBox.Show("连接断开：服务器已关闭", true);
                    break;
                case 1:
                    MirMessageBox.Show("连接断开：账号在另一地点登录，被迫下线.", true);
                    break;
                case 2:
                    MirMessageBox.Show("连接断开：数据错误.", true);
                    break;
                case 3:
                    MirMessageBox.Show("连接断开：服务器崩溃.", true);
                    break;
                case 4:
                    MirMessageBox.Show("连接断开：管理员踢下线.", true);
                    break;
                case 5:
                    MirMessageBox.Show("连接断开：服务器人数已满.", true);
                    break;
            }

...
namespace Client.MirScenes
{
    public sealed class LoginScene : MirScene
    {
        ...
        public LoginScene()
        {
            ...
            _connectBox = new MirMessageBox("正在连接服务器.", MirMessageBoxButtons.Cancel);
        ...
        public override void Process()
        {
            if (!Network.Connected && _connectBox.Label != null)
                _connectBox.Label.Text = string.Format("正在连接服务器，{1}", "\n\n", Network.ConnectAttempt);
        }
        ...
        private void ClientVersion(S.ClientVersion p)
        {
            ...
            {
                case 0:
                    MirMessageBox.Show("登陆器版本过低，加QQ群607440294下载最新登陆器\n \n点击确定退出", true);
        ...
        private void NewAccount(S.NewAccount p)
        {
            ...
            {
                case 0:
                    MirMessageBox.Show("禁止创建新账号，请联系管理员.");
                    _account.Dispose();
                    break;
                case 1:
        ...
        private void Login(S.Login p)
        {
            ...
            switch (p.Result)
            {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    MirMessageBox.Show("账号密码不安全，请修改密码后登录.");                    
        ...
        public sealed class NewAccountDialog : MirImageControl
        {
            ...
            private void AccountIDTextBox_GotFocus(object sender, EventArgs e)
            {
                ...
                Description.Text = " 说明:账号.\n 可用字符 a-2 A-Z 0-9.\n 长度: 介于 " +
                                   Globals.MinAccountIDLength + " 至 " + Globals.MaxAccountIDLength + " 字符之间.";
            }
            private void PasswordTextBox_GotFocus(object sender, EventArgs e)
            {
                Description.Visible = true;
                Description.Text = " 说明:密码.\n 可用字符 a-2 A-Z 0-9.\n 长度: 介于 " +
                                   Globals.MinPasswordLength + " 至 " + Globals.MaxPasswordLength + " 字符之间.";
            }

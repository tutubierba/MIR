...
namespace Client.MirScenes.Dialogs
{
    public sealed class GroupDialog : MirImageControl
    {
        ...
        public void AddMember(string name)
        {
            ...
            {
                GameScene.Scene.ChatDialog.ReceiveChat("队伍人数已满.", ChatType.System);
                return;
            }
            if (GroupList.Count > 0 && GroupList[0] != MapObject.User.Name)
            {
        ...
        private void AddMember()
        {
            ...
            MirInputBox inputBox = new MirInputBox("输入要添加进队伍的角色名字");
        ...
        private void DelMember()
        {
            ...
            MirInputBox inputBox = new MirInputBox("输入要移除出队伍的角色名字");

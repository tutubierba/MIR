...
namespace Client.MirScenes.Dialogs
{
    public sealed class HeroInventoryDialog : MirImageControl
    {
        ...
        public HeroInventoryDialog()
        {
            ...
            HPButton.Click += (o1, e) =>
            {
                MirAmountBox amountBox = new MirAmountBox("设置", 116, 99);
    ...
    public sealed class HeroBeltDialog : MirImageControl
    {
        ...
        public HeroBeltDialog()
        {
            ...
            CloseButton = new MirButton
            {
                ...
                PressedIndex = 1925,
                Sound = SoundList.ButtonA,
                Hint = string.Format("关闭({0})", CMain.InputKeys.GetKey(KeybindOptions.Belt))
            };
            CloseButton.Click += (o, e) => Hide();
    ...
    public sealed class HeroMenuPanel : MirImageControl
    {
        ...
        public HeroMenuPanel(MirControl parent)
        {
            ...
            HeroMagicsButton = new MirButton
            {
                ...
                Hint = string.Format("英雄技能({0})", CMain.InputKeys.GetKey(KeybindOptions.HeroSkills))
            };
            ...
            HeroInventoryButton = new MirButton
            {
                ...
                Hint = string.Format("英雄包裹({0})", CMain.InputKeys.GetKey(KeybindOptions.HeroInventory))
            };
            ...
            HeroEquipmentButton = new MirButton
            {
                ...
                Hint = string.Format("英雄名称({0})", CMain.InputKeys.GetKey(KeybindOptions.HeroEquipment))
            };
        ...
        public HeroBehaviourPanel()
        {
            ...
            for (int i = 0; i < BehaviourButtons.Length; i++)
            {
                ...
                BehaviourButtons[i] = new MirButton
                {
                    ...
                    Parent = this,
                    Sound = SoundList.ButtonA,
                    Hint = $"英雄状态: {Enum.GetName(typeof(HeroBehaviour), i)}",
    ...
    public sealed class HeroManageDialog : MirImageControl
    {
        ...
        public HeroManageDialog()
        {
            ...
            for (int i = 0; i < Avatars.Length; i++)
            {
                ...
                Avatars[i].Click += (o, e) =>
                {
                    MirMessageBox messageBox = new MirMessageBox($"你想要使用{Avatars[index].Info.Name}激活你的英雄吗？", MirMessageBoxButtons.YesNo);

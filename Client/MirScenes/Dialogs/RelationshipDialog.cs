    ...
    public sealed class RelationshipDialog : MirImageControl
    {
        ...
        public RelationshipDialog()
        {
            ...
            WhisperButton.Click += (o, e) =>
            {
                ...
                if (MapName == "")
                {
                    GameScene.Scene.ChatDialog.ReceiveChat("情人不在线", ChatType.System);
                    return;
                }
        ...
        {
            LoverNameLabel.Text = "情人:  " + LoverName;

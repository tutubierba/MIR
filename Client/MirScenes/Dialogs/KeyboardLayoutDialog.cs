    ...
    public sealed class KeyboardLayoutDialog : MirImageControl
    {
        ...
        public KeyboardLayoutDialog()
        {
            ...
            ResetButton.Click += (o, e) =>
            {
                ...
                MirMessageBox messageBox = new MirMessageBox("恢复默认键位设置.", MirMessageBoxButtons.OK);
                messageBox.Show();
            };
        ...
        private void EnforceButton_Click(object sender, EventArgs e)
        {
            ...
            if (Enforce) EnforceButtonLabel.Text = "分配规则：严格";
            else EnforceButtonLabel.Text = "分配规则：宽松";
        }

    ...
    public sealed class MainDialog : MirImageControl
    {
        ...
        public MainDialog()
        {
            ...
            InventoryButton = new MirButton
            {
                ...
                Hint = string.Format("包裹({0})", CMain.InputKeys.GetKey(KeybindOptions.Inventory))
            };
            ...
            CharacterButton = new MirButton
            {
                ...
                PressedIndex = 1902,
                Sound = SoundList.ButtonA,
                Hint = string.Format("角色({0})", CMain.InputKeys.GetKey(KeybindOptions.Equipment))
            };
            ...
            SkillButton = new MirButton
            {
                ...
                PressedIndex = 1908,
                Sound = SoundList.ButtonA,
                Hint = string.Format("技能({0})", CMain.InputKeys.GetKey(KeybindOptions.Skills))
            };
            ...
            QuestButton = new MirButton
            {
                ...
                PressedIndex = 1911,
                Sound = SoundList.ButtonA,
                Hint = string.Format("任务({0})", CMain.InputKeys.GetKey(KeybindOptions.Quests))
            };
            ...
            OptionButton = new MirButton
            {
                ...
                PressedIndex = 1914,
                Sound = SoundList.ButtonA,
                Hint = string.Format("设置({0})", CMain.InputKeys.GetKey(KeybindOptions.Options))
            };
            ...
            GameShopButton = new MirButton
            {
                ...
                PressedIndex = 828,
                Sound = SoundList.ButtonC,
                Hint = string.Format("商城({0})", CMain.InputKeys.GetKey(KeybindOptions.GameShop))
            };
    ...
    public sealed class OptionDialog : MirImageControl
    {
        ...
        public OptionDialog()
        {
            ...
            NewMoveOn.Click += (o, e) =>
            {
                ...
                GameScene.Scene.ChatDialog.ReceiveChat("[新操作模式]", ChatType.Hint);
            };
            ...
            NewMoveOff.Click += (o, e) =>
            {
                ...
                GameScene.Scene.ChatDialog.ReceiveChat("[旧操作模式]", ChatType.Hint);
            };
    ...
    public sealed class MenuDialog : MirImageControl
    {
        ...
        public MenuDialog()
        {
            ...
            ExitButton = new MirButton
            {
                ...
                PressedIndex = 635,
                Hint = string.Format("退出({0})", CMain.InputKeys.GetKey(KeybindOptions.Exit))
            };
            ...
            LogOutButton = new MirButton
            {
                ...
                PressedIndex = 638,
                Hint = string.Format("小退({0})", CMain.InputKeys.GetKey(KeybindOptions.Logout))
            };
            ...
            HelpButton = new MirButton
            {
                ...
                Hint = string.Format("帮助({0})", CMain.InputKeys.GetKey(KeybindOptions.Help))
            };
            ...
            KeyboardLayoutButton = new MirButton
            {
                ...
                Visible = true,
                Hint = "按键 (" + CMain.InputKeys.GetKey(KeybindOptions.Keybind) + ")"
            };
            ...
            RankingButton = new MirButton
            {
                ...
                Hint = string.Format("排行榜({0})", CMain.InputKeys.GetKey(KeybindOptions.Ranking))
                //Visible = false
            };
            ...
            IntelligentCreatureButton = new MirButton
            {
                ...
                Hint = string.Format("宠物({0})", CMain.InputKeys.GetKey(KeybindOptions.Creature))
            };
            ...
            RideButton = new MirButton
            {
                ...
                Hint = string.Format("坐骑({0})", CMain.InputKeys.GetKey(KeybindOptions.MountWindow))
            };
            ...
            FishingButton = new MirButton
            {
                ...
                Hint = string.Format("钓鱼({0})", CMain.InputKeys.GetKey(KeybindOptions.Fishing))
            };
            ...
            FriendButton = new MirButton
            {
                ...
                Visible = true,
                Hint = string.Format("好友({0})", CMain.InputKeys.GetKey(KeybindOptions.Friends))
            };
            FriendButton.Click += (o, e) =>
            {
            ...
            MentorButton = new MirButton
            {
                ...
                Visible = true,
                Hint = string.Format("师徒({0})", CMain.InputKeys.GetKey(KeybindOptions.Mentor))
            };
            MentorButton.Click += (o, e) =>
            {
            ...
            RelationshipButton = new MirButton  /* lover button */
            {
                ...
                Visible = true,
                Hint = string.Format("关系({0})", CMain.InputKeys.GetKey(KeybindOptions.Relationship))
            };
            ...
            GroupButton = new MirButton
            {
                ...
                Hint = string.Format("编组({0})", CMain.InputKeys.GetKey(KeybindOptions.Group))
            };
            GroupButton.Click += (o, e) =>
            {
            ...
            GuildButton = new MirButton
            {
                ...
                Hint = string.Format("行会({0})", CMain.InputKeys.GetKey(KeybindOptions.Guilds))
            };
            GuildButton.Click += (o, e) =>
            {

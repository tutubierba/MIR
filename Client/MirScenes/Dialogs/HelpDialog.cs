...
namespace Client.MirScenes.Dialogs
{
    public sealed class HelpDialog : MirImageControl
    {
        ...
        private void LoadImagePages()
        {
            ...
            List<HelpPage> imagePages = new List<HelpPage> { 
                ...
                new HelpPage("采集物品", 2, null) { Parent = this, Location = location, Visible = false },
                ...
                new HelpPage("宝石和珠宝", 28, null) { Parent = this, Location = location, Visible = false },
            };
    ...
    public class ShortcutPage2 : ShortcutInfoPage
    {
        ...
        {
            Shortcuts = new List<ShortcutInfo>();
            Shortcuts.Add(new ShortcutInfo(CMain.InputKeys.GetKey(KeybindOptions.ChangePetmode), "切换宠物攻击/移动攻击"));
            ...
            Shortcuts.Add(new ShortcutInfo(CMain.InputKeys.GetKey(KeybindOptions.AttackmodeGroup), "编组模式 - 攻击时不会伤害到组队成员"));
            Shortcuts.Add(new ShortcutInfo(CMain.InputKeys.GetKey(KeybindOptions.AttackmodeGuild), "行会模式 - 攻击时不会伤害到行会成员"));
            Shortcuts.Add(new ShortcutInfo(CMain.InputKeys.GetKey(KeybindOptions.AttackmodeRedbrown), "善恶模式 - 攻击时只会伤害怪物和犯罪玩家"));
            Shortcuts.Add(new ShortcutInfo(CMain.InputKeys.GetKey(KeybindOptions.AttackmodeAll), "全体模式 - 攻击时会伤害到所有玩家"));

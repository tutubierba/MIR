    ...
    public sealed class InventoryDialog : MirImageControl
    {
        ...
        public InventoryDialog()
        {
            ...
            AddButton.Click += (o1, e) =>
            {
                ...
                MirMessageBox messageBox = new MirMessageBox(string.Format("你确定要花费：{0:###,###}金币购买4个额外背包空间吗？", openGold), MirMessageBoxButtons.OKCancel);
        ...
        void Button_Click(object sender, EventArgs e)
        {
            ...
            {
                MirMessageBox messageBox = new MirMessageBox("你确定要花费：1000000金币购买8个额外背包空间吗？", MirMessageBoxButtons.OKCancel);

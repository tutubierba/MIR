...
namespace Client.MirScenes.Dialogs
{
    public sealed class GameShopDialog : MirImageControl
    {
        ...
        public string ClassFilter = "全部";
        public string TypeFilter = "全部";
        public string SectionFilter = "全部";
        ...
        public void ResetTabs()
        {
            ...
            if (SectionFilter == "全部") allItems.Index = 771;
            if (SectionFilter == "热卖") topItems.Index = 777;
            if (SectionFilter == "推荐") Deals.Index = 773;
        ...
        public void ResetClass()
        {
            ...
            if (ClassFilter == "全部") ALL.Index = 752;
        ...
        public void GetCategories()
        {
            ...
            for (int i = 0; i < shopList.Count; i++)
            {
                ...
                {
                    if (shopList[i].Class == ClassFilter || shopList[i].Class == "全部" || ClassFilter == "全部")
                    {
                        if (SectionFilter == "全部" || SectionFilter == "热卖" && shopList[i].TopItem || SectionFilter == "推荐" && shopList[i].Deal || SectionFilter == "新品" && shopList[i].Date > CMain.Now.AddDays(-7))
        ...
        public void UpdateShop()
        {
            ...
            {
                if (ShopList[i].Class == ClassFilter || ShopList[i].Class == "全部" || ClassFilter == "全部")
                    if (ShopList[i].Category == TypeFilter || TypeFilter == "全部")
                    {
                        if (SectionFilter == "全部" || SectionFilter == "热卖" && ShopList[i].TopItem || SectionFilter == "推荐" && ShopList[i].Deal || SectionFilter == "新品" && ShopList[i].Date > CMain.Now.AddDays(-7))

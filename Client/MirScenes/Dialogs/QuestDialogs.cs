...
namespace Client.MirScenes.Dialogs
{
    public sealed class QuestListDialog : MirImageControl
    {
        ...
        public QuestListDialog()
        {
            ...
            _finishButton.Click += (o, e) =>
            {
                ...
                {
                    MirMessageBox messageBox = new MirMessageBox("你必须选择奖励物品.");
                    messageBox.Show();
                    return;
                }
    ...
    public sealed class QuestDetailDialog : MirImageControl
    {
        ...
        public QuestDetailDialog()
        {
            ...
            {
                MirMessageBox messageBox = new MirMessageBox("你确定要取消此任务吗?", MirMessageBoxButtons.YesNo);
    ...
    public sealed class QuestRow : MirControl
    {
        ...
        public void UpdateInterface()
        {
            ...
            RequirementLabel.Text = Quest.QuestInfo.MinLevelNeeded > 0 ? "等级 " + Quest.QuestInfo.MinLevelNeeded : "";
    ...
    public sealed class QuestMessage : MirControl
    {
        ...
        private const string TaskTitle = "任务", ProgressTitle = "进度", ReturnTitle = "任务回复", TimeLimitTitle = "任务时限";
    ...
    public sealed class QuestSingleQuestItem : MirControl
    {
        ...
        public QuestSingleQuestItem(ClientQuestProgress quest)
        {
            ...
            string level = string.Format("等级{0}", Quest.QuestInfo.MinLevelNeeded);

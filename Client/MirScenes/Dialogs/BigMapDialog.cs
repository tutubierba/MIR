...
namespace Client.MirScenes.Dialogs
{
    ...
    {        
        ...
        //            SearchTextBox.TextBox.SelectionLength = 0;
        //            SearchTextBox.TextBox.SelectionStart = SearchTextBox.Text.Length;
        //            e.Handled = true;
        //            break;
        //    }
        //}
        ...
        private void TeleportToNPC()
        {
            ...
            MirMessageBox messageBox = new MirMessageBox($"花费{GameScene.TeleportToNPCCost} 金币传送到这个NPC", MirMessageBoxButtons.YesNo);
            messageBox.YesButton.Click += (o, e) =>
            {
                if (GameScene.Gold < GameScene.TeleportToNPCCost)
                {
                    MirMessageBox messageBox2 = new MirMessageBox("没有足够的金币", MirMessageBoxButtons.OK);
                    messageBox2.Show();
                    return;
                }
    ...
    public sealed class BigMapViewPort : MirControl
    {
        ...
        private void OnBeforeDraw()
        {
            ...
            Rectangle viewRect = new Rectangle(0, 0, Math.Min(568, Size.Width * 10 - 20), Math.Min(380, Size.Height * 10 - 20));

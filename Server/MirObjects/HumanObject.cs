    ...
    public class HumanObject : MapObject
    {
        ...
        public override void Process()
        {
            ...
            if (ReincarnationReady && Envir.Time >= ReincarnationExpireTime)
            {
                ...
                ReceiveChat("转生失败.", ChatType.System);
            }
        ...
        protected bool TryLuckWeapon()
        {
            ...
            else if (item.AddedStats[Stat.Luck] <= 0 || Envir.Random.Next(10 * item.GetTotal(Stat.Luck)) == 0)
            {
                ...
                item.AddedStats[Stat.Luck]++;
                Enqueue(new S.RefreshItem { Item = item });
                ReceiveChat("你的武器获得了祝福", ChatType.Hint);
            }
            else
            {
        ...
        protected bool CanUseItem(UserItem item)
        {
            ...
            switch (Gender)
            {
                case MirGender.男:
                    ...
                    {
                        ReceiveChat("男性角色无法使用", ChatType.System);
                        return false;
                    }
                    break;
                case MirGender.女:
                    ...
                    {
                        ReceiveChat("女性角色无法使用", ChatType.System);
                        return false;
                    }
                    break;
            }
            ...
            switch (Class)
            {
                case MirClass.战士:
                    ...
                    {
                        ReceiveChat("战士无法使用此物品", ChatType.System);
                        return false;
                    }
                    break;
                case MirClass.法师:
                    ...
                    {
                        ReceiveChat("魔法师无法使用此物品.", ChatType.System);
                        return false;
                    }
                    break;
                case MirClass.道士:
                    ...
                    {
                        ReceiveChat("道士无法使用此物品.", ChatType.System);
                        return false;
                    }
                    break;
                case MirClass.刺客:
                    ...
                    {
                        ReceiveChat("刺客无法使用此物品.", ChatType.System);
                        return false;
                    }
                    break;
            }
            ...
            switch (item.Info.RequiredType)
            {
                case RequiredType.Level:
                    ...
                    {
                        ReceiveChat("等级太低.", ChatType.System);
                        return false;
                    }
                    break;
                ...
                case RequiredType.MaxMAC:
                    ...
                    {
                        ReceiveChat("魔法防御不足.", ChatType.System);
                        return false;
                    }
                    break;
                ...
                case RequiredType.MaxMC:
                    ...
                    {
                        ReceiveChat("魔法不足", ChatType.System);
                        return false;
                    }
                    break;
                ...
                case RequiredType.MinAC:
                    ...
                    {
                        ReceiveChat("基础防御不足", ChatType.System);
                        return false;
                    }
                    break;
                case RequiredType.MinMAC:
                    ...
                    {
                        ReceiveChat("基础魔法防御不足", ChatType.System);
                        return false;
                    }
                    break;
                case RequiredType.MinDC:
                    ...
                    {
                        ReceiveChat("基础攻击不足", ChatType.System);
                        return false;
                    }
                    break;
                case RequiredType.MinMC:
                    ...
                    {
                        ReceiveChat("基础魔法不足.", ChatType.System);
                        return false;
                    }
                    break;
                case RequiredType.MinSC:
                    ...
                    {
                        ReceiveChat("基础道术不足.", ChatType.System);
                        return false;
                    }
                    break;
            }
            ...
            switch (item.Info.Type)
            {
                case ItemType.Scroll:
                    switch (item.Info.Shape)
                    {
                        case 0:
                            ...
                            {
                                ReceiveChat("禁止使用地牢传送卷", ChatType.System);
                                return false;
                            }
                            break;
                        case 1:
                            ...
                            {
                                ReceiveChat("禁止使用回城卷", ChatType.System);
                                return false;
                            }
                            break;
                        case 2:
                            ...
                            {
                                ReceiveChat("禁止使用随机传送卷", ChatType.System);
                                return false;
                            }
                            break;
                        case 6:
                            if (!Dead)
                            {
                                ReceiveChat("禁止使用复活卷轴", ChatType.Hint);
                                return false;
                            }
                            break;
                        case 10:
                            {
                                ...
                                if (MyGuild == null)
                                {
                                    ReceiveChat("必须加入一个行会才能使用这个技能", ChatType.Hint);
                                    return false;
                                }
                                if (MyGuildRank != MyGuild.Ranks[0])
                                {
                                    ReceiveChat("行会掌门才能使用这个技能", ChatType.Hint);
                                    return false;
                                }
                                ...
                                {
                                    ReceiveChat("行会已经拥有这个技能了", ChatType.Hint);
                                    return false;
                                }
                            }
                            break;
                ...
                case ItemType.Potion:
                    ...
                    {
                        ReceiveChat("禁止使用药品", ChatType.System);
                        return false;
                    }
                    break;
                ...
                case ItemType.Reins:
                    ...
                    {
                        ReceiveChat("仅限坐骑使用", ChatType.System);
                        return false;
                    }
                    break;
                case ItemType.Hook:
                ...
                case ItemType.Reel:
                    ...
                    {
                        ReceiveChat("仅限和鱼竿搭配使用", ChatType.System);
                        return false;
                    }
                    break;
                ...
                case ItemType.Pets:
                    switch (item.Info.Shape)
                    {
                        ...
                        case 22://nuts maintain food levels
                            if (!CreatureSummoned)
                            {
                                ReceiveChat("仅限宠物使用", ChatType.System);
                                return false;
                            }
                            break;
                        case 23://basic creature food
                            ...
                            else
                            {
                                for (int i = 0; i < Pets.Count; i++)
                                {
                                    ...
                                    {
                                        ReceiveChat(pet.Name + " 已经吃饱了", ChatType.System);
                                        return false;
                                    }
                                    return true;
                                }
                        ...
                        case 24://wonderpill vitalize creature
                            ...
                            else
                            {
                                for (int i = 0; i < Pets.Count; i++)
                                {
                                    ...
                                    if (pet.Fullness > 0)
                                    {
                                        ReceiveChat(pet.Name + "无需激活", ChatType.System);
                                        return false;
                                    }
                                    return true;
                                }
            ...
            switch (target.Race)
            {
                ...
                case ObjectType.Hero:
                    ...
                    if (target.IsFriendlyTarget(this))
                    {
                        ...
                        else if (((HumanObject)target).Class == MirClass.法师 || ((HumanObject)target).Class == MirClass.弓箭手)
                        {
        ...
        public override void ApplyPoison(Poison p, MapObject Caster = null, bool NoResist = false, bool ignoreDefence = true)
        {
            ...
            for (int i = 0; i < PoisonList.Count; i++)
            {
                ...
                ReceiveChat("中毒了", ChatType.System2);
                PoisonList[i] = p;
                return;
            }
                ...
                case PoisonType.DelayedExplosion:
                    {
                        ...
                        ReceiveChat("你变成了一具行尸走肉.", ChatType.System);
                    }
                    break;
        ...
        public void RefreshMount(bool refreshStats = true)
        {
            if (RidingMount)
            {
                ...
                {
                    RidingMount = false;
                    ReceiveChat("需要坐骑鞍才能使用坐骑", ChatType.System);
                }
                else if (!Mount.CanMapRide)
                {
                    RidingMount = false;
                    ReceiveChat("此地图禁止使用坐骑", ChatType.System);
                }
                else if (!Mount.CanDungeonRide)
                {
                    RidingMount = false;
                    ReceiveChat("需要缰绳才能使用坐骑", ChatType.System);
                }
            }
            else
            {

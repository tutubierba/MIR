...
namespace Server
{
    public static class Settings
    {
        ...
        public static BaseStats[] ClassBaseStats = new BaseStats[5] { new BaseStats(MirClass.战士), new BaseStats(MirClass.法师), new BaseStats(MirClass.道士), new BaseStats(MirClass.刺客), new BaseStats(MirClass.弓箭手) };

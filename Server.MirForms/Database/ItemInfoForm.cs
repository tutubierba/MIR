...
namespace Server
{
    public partial class ItemInfoForm : Form
    {
        ...
        public ItemInfoForm()
        {
            ...
            ITypeFilterComboBox.Items.Add(new ComboBoxItem { Text = "所有" });
        ...
        public void RefreshUniqueTab()
        {
            ...
            {
                tabControl1.TabPages[3].Text = "特殊数据";
        ...
        private void RemoveButton_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("是否确实要删除所选物品?", "删除物品?", MessageBoxButtons.YesNo) != DialogResult.Yes) return;

...
namespace Server
{
    public partial class MapInfoForm : Form
    {
        ...
        private void RemoveButton_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("确实要删除选定的地图吗？", "删除地图?", MessageBoxButtons.YesNo) != DialogResult.Yes) return;
        ...
        private void RemoveSZButton_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("是否确实要删除选定的安全区域?", "删除安全区域?", MessageBoxButtons.YesNo) != DialogResult.Yes) return;
        ...
        private void RemoveRButton_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("是否确实要删除选定的重生?", "删除重生?", MessageBoxButtons.YesNo) != DialogResult.Yes) return;
        ...
        private void RPasteButton_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("无法粘贴，复制的数据不是复制内容.");
                return;
            }
        ...
        private void RemoveMButton_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("是否确实要删除选定的移动?", "删除选定移动?", MessageBoxButtons.YesNo) != DialogResult.Yes) return;
        ...
        private void MZDeletebutton_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("是否确实要删除选定的挖矿区域?", "删除挖矿区域?", MessageBoxButtons.YesNo) != DialogResult.Yes) return;

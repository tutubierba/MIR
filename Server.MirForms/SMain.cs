...
namespace Server
{
    public partial class SMain : Form
    {
        ...
        private void InterfaceTimer_Tick(object sender, EventArgs e)
        {
            try
            {
                Text = $"全部: {Envir.LastCount}, Real: {Envir.LastRealCount}";
                ...
                runningTimeLabel.Text = $"运行时长: {Envir.Stopwatch.ElapsedMilliseconds / 1000 / 60 / 60 / 24}天:{Envir.Stopwatch.ElapsedMilliseconds / 1000 / 60 / 60}时:{Envir.Stopwatch.ElapsedMilliseconds / 1000 / 60}分:{Envir.Stopwatch.ElapsedMilliseconds / 1000 % 60}秒";
                if (Settings.Multithreaded && (Envir.MobThreads != null))
                {
                    CycleDelayLabel.Text = $"循环周期: {Envir.LastRunTime:0000}";
                    ...
                    CycleDelayLabel.Text = $"循环周期: {Envir.LastRunTime}";
        ...
        private void monsterTunerToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("服务器必须运行才能调整怪物", "注意",
        ...
        private void Plane_TextChanged(object sender, EventArgs e)
        {
